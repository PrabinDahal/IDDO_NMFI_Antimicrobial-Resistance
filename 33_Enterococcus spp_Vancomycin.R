...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="Enterococcus spp." & dat$antibiotic %in% c("Vancomycin")),]
...
drugbug_africa2<- drugbug_africa1[which(!(drugbug_africa1$year_cat %in% c("1990-1999","2000-2009"))),] 
...
require(binom)
binom.confint(c(0,0),c(159,70), method="wilson")
