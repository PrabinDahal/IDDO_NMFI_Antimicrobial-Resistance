...
#-----------------------------------
drugbug <- dat[which(dat$pathogen=="Acinetobacter baumannii" & dat$antibiotic %in% c("Meropenem")),]
...
# Warning as 100% positive in one study 

# Since there are two sites; present Wilson's 95% for each site 
require(binom)
binom.confint(c(69,93),c(190,93), method="wilson")
