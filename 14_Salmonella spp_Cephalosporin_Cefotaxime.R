...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="Salmonella spp." & dat$antibiotic %in% c("Cefotaxime")),]
...
# Unstable estiamtes warning as two sub-groups do not have any events
drugbug_africa2<- drugbug_africa1[which(!(drugbug_africa1$year_cat %in% c("1980-1989", "2010-2016"))),]
...
require(binom)
binom.confint(c(0,0), c(76,2), method="wilson")
...
# Time period sub-group (1980-1989) from 1 site with no events
