...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="Salmonella spp." & dat$antibiotic=="Ofloxacin"),]
...
# Warning of "Cannot fit ML model" as there were no events
# Meta-analysis not carried out; instead simple proportion presented

require(binom)
binom.confint(c(0,0,0), c(73,1,74), method="wilson")
...
require(binom)
binom.confint(c(0), c(777), method="wilson")
