...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="E. Coli" & dat$antibiotic %in% c("Imipinem")),]
...
# Time period sub-group (2000-2009) from 2 study sites with no events

require(binom)
binom.confint(0,472, method="wilson")

drugbug_africa2 <- drugbug_africa1[which(drugbug_africa1$year_cat!="2000-2009"),]
...
# Warning of potential unstable estimates were returned
# Time period sub-group (1990-1999) from 3 sites with no events

binom.confint(0,18, method="wilson")
