...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="Streptococcus pneumoniae" & dat$antibiotic=="Erythromycin"),]
...
drugbug_africa2<- drugbug_africa1[which(!(drugbug_africa1$year_cat %in% c("1980-1989","2000-2009"))),] 
...
require(binom)
binom.confint(0,c(2,250), method="wilson")
