...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="Staphylococcus aureus" & dat$antibiotic=="Vancomycin"),]
...
drugbug_africa2<- drugbug_africa2[which(drugbug_africa2$year_cat!= "1990-1999"),] 
...
require(binom)
binom.confint(0,22, method="wilson")
binom.confint(0,693, method="wilson")
...
# Time period sub-group (1990-1999) from 6 sites with no events
...
require(binom)
binom.confint(0,281, method="wilson")
