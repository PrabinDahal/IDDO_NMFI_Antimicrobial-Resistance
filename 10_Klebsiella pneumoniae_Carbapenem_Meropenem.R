...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="Klebsiella pneumoniae" & dat$antibiotic %in% c("Meropenem")),]
...
# Time period sub-group (2010-2016) had no events


require(binom)
binom.confint(0,42, method="wilson")
