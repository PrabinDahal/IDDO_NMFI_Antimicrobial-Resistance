...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="E. Coli" & dat$antibiotic %in% c("Ceftazidime")),]
...
# Time period sub-group (1990s) from 1 study site had no event
# Re-analysis carried out by excluding this study 

drugbug_africa2 <- drugbug_africa1[which(drugbug_africa1$year_cat!="1990-1999"),]
