...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="Salmonella spp." & dat$antibiotic %in% c("Ceftriaxone")),]
...
# Warning as no events in studies before 2000s 

drugbug_africa2<- drugbug_africa1[which(!(drugbug_africa1$year_cat %in% c("1980-1989", "1990-1999"))),]
...
require(binom)
binom.confint(c(0,0),c(73,81), method="wilson")
...
# Time period sub-group (1980-1989) from 3 sites with no events

drugbug_asia2 <- drugbug_asia1[which(drugbug_asia1$year_cat!="1980-1989"),]
...
require(binom)
binom.confint(0,777, method="wilson")
