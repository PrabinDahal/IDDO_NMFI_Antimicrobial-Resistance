...
#-----------------------------------
drugbug <- dat[which(dat$pathogen_2=="Neisseria meningitidis" & dat$antibiotic %in% c("Ciprofloxacin")),]
...
require(binom)
binom.confint(c(0,0,3),c(1,17,20), method="wilson")
...
require(binom)
binom.confint(c(0,18,2),c(4,66,2), method="wilson")
